...
class SettingSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $settings = [
            ...
            //SEO Settings
            ['key' => 'seo_title', 'value' => 'Best Outline Store - Quality Products', 'type' => 'string', 'group' => 'seo'],
            ['key' => 'seo_description', 'value' => 'Shop the best products at great price. Free shipping on orders over $100', 'type' => 'string', 'group' => 'seo'],
